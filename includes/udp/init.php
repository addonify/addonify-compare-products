		...
		add_action(
			...
			function () {
				...
				$content = '<p>' . sprintf(
					...
					esc_html__( '%s is asking to allow tracking your non-sensitive WordPress data?', 'addonify-compare-products' ),
					$agent_name
				) . '</p>';
				...
				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=yes&nonce=' . $nonce ) ) . '" class="button button-primary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Allow', 'addonify-compare-products' ) . '</a>';

				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=no&nonce=' . $nonce ) ) . '" class="button button-secondary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Do not show again', 'addonify-compare-products' ) . '</a>';

				$content .= '<a href="' . esc_url( admin_url( '?udp-agent-allow-access=later&nonce=' . $nonce ) ) . '" class="button button-secondary udp-agent-access_tracking-yes" style="margin-right: 10px">' . esc_html__( 'Later', 'addonify-compare-products' ) . '</a>';
