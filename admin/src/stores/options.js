...
*/
const BASE_API_URL = ADDONIFY_COMPARE_PRODUCTS_LOCALIZER.rest_namespace;
...
export const useOptionsStore = defineStore({
    ...
    state: () => ({
        data: {},   // Holds all data like options, section, tab & fields.
    ...
    actions: {
        ...
        async updateOptions(payload) {
            try {
                ...
                if (!res.success) {
                    return ElMessage.error(({
                        message: __("Error saving changes! Please try again.", "addonify-compare-products"),
                        offset: 50,
                        duration: 15000,
                    }));
                }
