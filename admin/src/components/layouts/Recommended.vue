<script setup>
	...
	const activateText = __("Activate now", "addonify-compare-products");
	const activitingText = __("Activating...", "addonify-compare-products");
	const installText = __("Install now", "addonify-compare-products");
	const installingText = __("Installing...", "addonify-compare-products");
	const installedText = __("Installed", "addonify-compare-products");
