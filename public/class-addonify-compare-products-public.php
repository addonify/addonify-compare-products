...
class Addonify_Compare_Products_Public {
	...
	public function enqueue_scripts() {
		...
		$localize_args = array(
			...
			'messageOnNoProducts'     => esc_html__( 'No products to compare', 'addonify-compare-products' ),
			'messageOnOneProduct'     => esc_html__( 'More than one products required for comparison.', 'addonify-compare-products' ),
